...
//$hint_list  = $this->Db->getTableData('SccpExtension');
...
if (!empty($_REQUEST['id'])) {
    $dev_id = $_REQUEST['id'];
    $db_buttons = $this->Db->getTableData('get_sccpdevice_buttons', array("id" => $dev_id));
    $db_device = $this->Db->getTableData('get_sccpdevice_byid', array("id" => $dev_id));
...
//   $db_device = $this->Db->getTableData('get_sccpdevice_byid', array("id" => $val));
